...
I co-teach a for-credit course with colleagues in HSCL and ARCS, "GMS 5909: Finding Biomedical Research Information and Communicating Science", introducing reproducibility as an essential facet of the research process. While this graduate-level course was originally created for students in the health science, it has attracted students from throughout campus.
...
For example, I regularly lead a session in "GMS 7877: Responsible Conduct of Biomedical Research", disucssing reproducibility and its relationship with research integrity.
...
However, there are limitations to these forms of instruction.
Because research is so varied, and there is no "one size fits all" tool or method.
...
To maximize reach, I offer these workshops virtually through zoom, provide recordings to registered attendees, and share the instructional materials as individual websites linked through https://guides.uflib.ufl.edu/reproducibility/lessons.
...
I teach kills and techniques to help the teams in their project; these tutorials are positively received, with measured uptake of new practices during the events and invitations to return for future events.
...
This includes actions that are already established, such as sharing publications open access, as well as emergent, such as sharing data, analysis code, and pre-registered study protocols.
Some of my work explores these boundaries, in order to provide better guidance to researchers, as well as shape research practice more broadly.
...
This project engages with stakeholders across research sectors, including researchers, administrators, funders, and technologists, and will complete in 2023.
...
This collaboration brought together our lived experience and expertise in open science education and open science communities to (hopefully) inform policy at the highest levels.
...
For example, I co-led a paper on the need for better career support for research support specialists, but who are not typically acknowledge as researchers, "A manifesto for rewarding and recognising Team Infrastructure Roles", submitted to the _Journal of Trial and Error_.
...
I and the other committee members evaluated and recommended for funding, events that build inclusive data science communities. Through 3 rounds of awards, we supported 37 events, representing 27 countries and 6 continents.
...
The Data Caucus of the Medical Library Association consists of over 200 data librarians; as the elected chair of this group, I create capacity for collaborations and resource-sharing.
...
In support of this work, I have received training in Code of Conduct enforcement, and co-developed, with the rest of the committee, detailed procedures for documeting and responding to code of conduct incidents, should they arise.
