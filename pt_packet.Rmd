...
As the reproducibility librarian, I strive to promote better research practices that both improve reproducibility and make research more effective and efficient. One of the pillars of my work is to provide training and instruction in a variety of formats and settings.

In the for-credit course I co-teach with colleagues in HSCL and ARCS, "GMS 5909: Finding Biomedical Research Information and Communicating Science", I work to embed reproducibility as a core element in the research process. Although this course primarily reaches graduate students in the Health Science Colleges, I am able to expand my reach to more varied research disciplines and contexts through course-integrated instruction. For example, I regularly teach a session in "GMS 7877: Responsible Conduct of Biomedial Research", as well as in the Research Integrity Summer Seminar Series offered by the UF Office of Research. These courses are often used to satisfy training requirements in research integrity, reflecting the growing awareness of reproducibility as a cornerstone of effective research practices. In addition, I have led guest lectures for courses in diverse departments across UF, such as Genomics, Biomedical Engineering, Latin American Studies, and Entomology & Nemotology.

There are still many audiences not reached through these forms of instruction, as well as additional topics in reproducibility. Because research can take on so many forms, so too are there different aspects of reproducibility, and so there is no "one size fits all" tool or method that works for everyone. Consequently, I offer a number of standalone workshops through the UF Libraries on a diverse array of topics (a total of `r standalone_sessions` sessions with a total of `r standalone_attendees` attendees). To make these workshops actionable, they all feature practical skills that can be implemented immediately, as well as follow-up resources for further training and practice. I share these instructional materials as individual websites linked through https://guides.uflib.ufl.edu/reproducibility/lessons, to provide researchers with asynchronous access.

Improving research practices is a large-scale problem. Instead of trying to teach researchers directly, one of the ways I can have a larger impact is through developing the teaching skill of others. Thus, in summer 2021, I sought out and completed trainer training for The Carpentries, an international non-profit organization that develops and teaches coding and data science skills to researchers. As a certified instructor trainer, I can train new instructors, sustaining both The Carpentries global organization, as well as the local chapter at UF (the UF Carpentries Club). To date, I have taught `r NROW(carpentries_instructor_trainings)` instructor trainings with a total of `r sum(as.numeric(carpentries_instructor_trainings$num_attendees))` new instructors.

co-organize the Rigor and Reproducibility Seminar Series for the 
T32
Invite international experts to present on topics in research integrity, reproducibility, and open science. 
We initially had speakers every month, but soon transitioned to a once per semester. 
Well-received with attendance from outside UF, and including funders at NIH.
...
Coincident with growing 

I am especially proud that my expertise in reproducibility training has been sought out by a growing number of organizations outside of UF, including the National Institutes of Health Office of Data Science Strategy and the Afrian Society for Bioinformatics and Computational Biology, where I have been an invited guest instructorfor tutorials in their codeathon events.
...
have shared as open educational resources, in addition to trainings developed in conjunction with others.
...
growing interest in NINDS led to participating in NIH workshop on catalyzing research rigor champions 
